...
$routes = [
    ...
    'Game' => [ // Controller
        ...
        ['add', '/calendar/add', 'POST'], // action, url, method
        ['edit', '/calendar/edit-{id:\d+}', 'GET'], // action, url, method
        ['edit', '/calendar/edit-{id:\d+}', 'POST'], // action, url, method

    ],
    'Team' => [
        ['index', '/calendar/edit', 'GET'],
        ['index', '/calendar/edit', 'POST'],
